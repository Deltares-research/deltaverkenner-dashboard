...
if __name__ == "__main__":
    ...
    figpath = "p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/deltapolder/2-visualisation/kaart_drinkwaterbronnen_opp_grondwater_Vewin_KWR_2020.png"

    plot_waterbronnen(
        waterbronnen,
        hoofdregios,
        figpath,
        axis_title="Drinkwaterbronnen opp grondwater onttrekkingen KWR",
    )
