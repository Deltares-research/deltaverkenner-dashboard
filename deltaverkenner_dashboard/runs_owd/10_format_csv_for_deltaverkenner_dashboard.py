...
if __name__ == "__main__":
    ...
    writer = pd.ExcelWriter(
        Path(
            "p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/2-output/dashboard_2026_data_2018_run_from_python.xlsx"
        )
    )

    print("Working on 2018 run")

    path_to_datafile = Path(
        "p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/runs_2018/4-final/output_2018_run.csv"
    )
    ...
    selected_data = data[data.index.month.isin(selected_months)]
    ...
    selected_data_grouped = selected_data.T.groupby(by=selected_data.columns).sum().T
    ...
    selected_data_grouped.to_excel(writer, sheet_name="2018 run")
