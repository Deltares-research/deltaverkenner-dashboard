...
for watervraag_type in watervraag_types:
    ...
    for selected_month in selected_months:
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2050/Voor_Dimmie_2026_08_28/Figuren Dimmie/07_{run}_watertekort_{watervraag_type.lower()}_deelregios_{selected_month}_1976.png"
        )
        ...
        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2050/Voor_Dimmie_2026_08_28/csv's Dimmie/07_{run}_watertekort_{watervraag_type.lower()}_deelregios_{selected_month}_1976.csv"
