...
for watervraag_type in watervraag_types:
    ...
    for selected_month in selected_months:
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2100/Figuren Dimmie/01_{run}_watervraag_{watervraag_type.lower()}_deelregios_{selected_month}_1976.png"
        )
        ...
        deelregios_with_watervraag = deelregios_with_watervraag.rename(columns={"Watervraag":"Watervraag (m3/s)"})

        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2100/csv's Dimmie/01_{run}_watervraag_{watervraag_type.lower()}_deelregios_{selected_month}_1976.csv"
