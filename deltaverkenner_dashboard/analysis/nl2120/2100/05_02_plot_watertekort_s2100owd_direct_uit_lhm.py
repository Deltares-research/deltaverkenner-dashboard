...
for watervraag_type in watervraag_types:
    ...
    for selected_month in selected_months:
        ...
        ax.set_title(
            f"{run}owd - watertekort, {watervraag_type.lower()}", fontsize=14, loc="right"
        )
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2100/Voor Dimmie 2026_08_28/Figuren Dimmie/05_S2100owd_watertekort_totaal_deelregios_{selected_month}_1976.png"
        )
        ...
        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/2100/Voor Dimmie 2026_08_28/csv's Dimmie/05_S2100owd_watertekort_totaal_deelregios_{selected_month}_1976.csv"
