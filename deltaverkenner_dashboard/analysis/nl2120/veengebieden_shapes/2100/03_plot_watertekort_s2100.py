...
for watervraag_type in watervraag_types:
    for selected_month in selected_months:
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2100/Figuren Dimmie/03_watertekort_{run2}_deelregios_{selected_month}_1976.png"
        )
        ...
        deelgebied_gdf = deelgebied_gdf.drop(
            columns=["geometry", "watervraag_deelgebied", "id_num"]
        )
        ...
        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2100/csv's Dimmie/03_watertekort_{run2}_deelregios_{selected_month}_1976.csv"
