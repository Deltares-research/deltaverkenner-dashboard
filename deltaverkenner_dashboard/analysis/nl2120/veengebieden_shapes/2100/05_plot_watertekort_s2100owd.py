...
for watervraag_type in watervraag_types:
    for selected_month in selected_months:
        ...
        diff[f"Difference with {run1}"] = (
            data_dict[run2]["watervraag_deelgebied"]
            - data_dict[run1]["watervraag_deelgebied"]
        )
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2100/Figuren Dimmie/05_watertekort_{run2}owd_deelregios_{selected_month}_1976.png"
        )
        ...
        deelgebied_gdf = deelgebied_gdf.drop(
            columns=["geometry", "id_num", "watervraag_deelgebied"]
        )
        ...
        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2100/csv's Dimmie/05_watertekort_{run2}owd_deelregios_{selected_month}_1976.csv"
