...
for watervraag_type in watervraag_types:
    for selected_month in selected_months:
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2050/watertekort_{run2}_deelregios_{selected_month}_1976.png"
        )
