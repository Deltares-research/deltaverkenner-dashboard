...
for watervraag_type in watervraag_types:
    for selected_month in selected_months:
        ...
        figpath = Path(
            f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2050/Figuren Dimmie/06_diff_{run2}-{run1}_watervraag_{watervraag_type.lower()}_veengebieden_{selected_month}_1976.png"
        )
        ...
        outputpath = f"p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/2050/csv's Dimmie/06_{run}_toename_watervraag_{watervraag_type.lower()}_veengebieden_{selected_month}_1976.csv"
