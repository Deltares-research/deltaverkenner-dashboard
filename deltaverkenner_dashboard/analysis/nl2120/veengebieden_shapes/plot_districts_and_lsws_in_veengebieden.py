...
lsw_in_veengebieden_shapes = lsws_merged[
    lsws_merged["LSWFINAL"].isin(lsw_in_veengebieden["LSWFINAL"])
]

# remove LSW 110213 and 21043
lsw_in_veengebieden_shapes = lsw_in_veengebieden_shapes[
    ~lsw_in_veengebieden_shapes["LSWFINAL"].isin([110213, 21043])
]
...
lsws.plot(ax=ax, facecolor="lightblue", edgecolor="grey", linewidth=0.1)
...
lsw_in_veengebieden_shapes.plot(
    ax=ax, facecolor="green", edgecolor="black", linewidth=0.1
)
...
figpath = Path(
    "p:/11212687-deltaverkenner2026/Zoetwater/Dashboard/data/nl2120/figuren/shapes_veengebieden/districts_and_lsws_in_veengebieden_26-08-07.png"
)
